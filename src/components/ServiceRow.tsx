...
const styles = StyleSheet.create({
  ...
  typeBadge:    { paddingHorizontal: 7, paddingVertical: 2, borderRadius: radius.sm, borderWidth: 1 },
  typeBadgeText:{ fontSize: font.xs, fontWeight: '700' },
  statusChip:   { flexDirection: 'row', alignItems: 'center', gap: 4, paddingHorizontal: 8, paddingVertical: 3, borderRadius: radius.sm, borderWidth: 1 },
  statusDot:    { width: 6, height: 6, borderRadius: 3 },
  statusChipText:{ fontSize: font.xs, fontWeight: '600' },
  name:         { fontSize: font.md, fontWeight: '700' },
  metaRow:      { flexDirection: 'row', gap: 6, flexWrap: 'wrap' },
  metaChip:     { flexDirection: 'row', alignItems: 'center', gap: 4, paddingHorizontal: 7, paddingVertical: 3, borderRadius: radius.sm, borderWidth: 1 },
  metaChipText: { fontSize: font.xs, fontWeight: '600' },
  usedByRow:    { flexDirection: 'row', flexWrap: 'wrap', gap: 4 },
  usedChip:     { flexDirection: 'row', alignItems: 'center', gap: 3, paddingHorizontal: 7, paddingVertical: 3, borderRadius: radius.sm, borderWidth: 1, maxWidth: 160 },
