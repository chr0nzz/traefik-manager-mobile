...
export default function CrowdSecSettingsScreen() {
  ...
  return (
    <View style={[styles.screen, { backgroundColor: c.bg }]}>
      <View style={[styles.headerBar, { paddingTop: insets.top + 4, borderBottomColor: c.border, backgroundColor: c.card }]}>
        ...
        <Text style={[styles.headerTitle, { color: c.text }]}>CrowdSec</Text>
        ...
        <Surface style={[styles.group, { backgroundColor: c.card }]} elevation={1}>
          <View style={styles.row}>
            <View style={styles.rowLeft}>
              <Text style={[styles.rowLabel, { color: c.text }]}>Show CrowdSec Tab</Text>
              <Text style={[styles.rowHint, { color: c.muted }]}>Adds a CrowdSec tab to the More menu</Text>
            </View>
            <Switch value={showCrowdSecTab} onValueChange={setShowCrowdSecTab} />
          </View>
        </Surface>
        <Text style={[styles.hint, { color: c.muted }]}>
          Shows active CrowdSec decisions and recent alerts. Configure CrowdSec credentials (LAPI URL and API key) in the Traefik Manager web panel under Settings.
        </Text>
      </ScrollView>
    </View>
  );
