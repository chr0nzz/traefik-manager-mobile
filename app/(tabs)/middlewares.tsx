...
import { AddMiddlewareModal } from '../../src/components/AddMiddlewareModal';
      ...
      <TopBar
        ...
        right={
          <View style={{ flexDirection: 'row', alignItems: 'center', gap: 4 }}>
            ...
            <TouchableOpacity onPress={() => setShowAdd(true)} hitSlop={8} style={[styles.topBarBtn, { borderColor: c.purple + '55' }]}>
              <MaterialCommunityIcons name="plus" size={18} color={c.purple} />
            </TouchableOpacity>
          </View>
        }
      />
      <AddMiddlewareModal visible={showAdd} onClose={() => setShowAdd(false)} />
