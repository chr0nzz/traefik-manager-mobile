...
const TEMPLATES: Template[] = [
  ...
  { id: 'oidcAuth', name: 'OIDC Auth', icon: 'login-variant', description: 'OpenID Connect auth via plugin', yaml: 'plugin:\n  traefik-oidc-auth:\n    provider:\n      url: "https://accounts.example.com"\n    clientId: ""\n    clientSecret: ""\n    scopes:\n      - "openid"\n      - "email"\n      - "profile"\n    session:\n      secret: ""\n      maxAge: 3600' },
...
const TEMPLATE_COLORS: Record<string, string> = {
  ...
  'forward-auth-authelia': 'purple', 'forward-auth-gatekeeper': 'purple', 'oidcAuth': 'teal',
